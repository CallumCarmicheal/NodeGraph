...
namespace NodeGraph {
    ...
    public class NodeGraphManager {
        ...
        public readonly Dictionary<Guid, ObservableCollection<Guid>> SelectedNodes = new Dictionary<Guid, ObservableCollection<Guid>>();
        public bool OutputDebugInfo = false;
        public SelectionMode SelectionMode = SelectionMode.Overlap;
        ...
        public FlowChart CreateFlowChart(bool isDeserializing, Guid guid, Type flowChartModelType) {
            ...
            FlowChart flowChart = Activator.CreateInstance(flowChartModelType, new object[] { this, guid }) as FlowChart;
        ...
        public Node CreateNode(bool isDeserializing, Guid guid, FlowChart flowChart, Type nodeType, double x, double y, int ZIndex,
            ...
            // create node model.
            Node node = Activator.CreateInstance(nodeType, new object[] { this, guid, flowChart }) as Node;
            node.X = x;
            node.Y = y;
            node.ZIndex = ZIndex;
            Nodes.Add(guid, node);
            ...
            flowChart.ViewModel.NodeViewModels.Add(vm);
            vm.View.NodeGraphManager = this;

            flowChart.Nodes.Add(node);

            //---- history.

            flowChart.History.AddCommand(new NodeGraph.History.CreateNodeCommand(this,
                "Creating node", node.Guid, SerializeNode(node)));
        ...
        public void DestroyNode(Guid guid) {
            ...
            if (Nodes.TryGetValue(guid, out node)) {
                ...
                node.Owner.History.AddCommand(new NodeGraph.History.DestroyNodeCommand(this,
        ...
        public Connector CreateConnector(bool isDeserializing, Guid guid, FlowChart flowChart, Type connectorType = null) {
            ...
            Connector connector = Activator.CreateInstance(connectorType, new object[] { this, guid, flowChart }) as Connector;
        ...
        public void DestroyNodePort(Guid guid) {
            ...
            node.Owner.History.AddCommand(new History.DestroyNodePortCommand(this,
        ...
        public NodeFlowPort CreateNodeFlowPort(bool isDeserializing, Guid guid, Node node, bool isInput, Type portViewModelTypeOverride = null,
            ...
            NodeFlowPort port = Activator.CreateInstance(typeof(NodeFlowPort),
                new object[] { this, guid, node, isInput }) as NodeFlowPort;
            port.NodeGraphManager = this;
            port.Name = name;
            ...
            node.Owner.History.AddCommand(new History.CreateNodePortCommand(this,
        ...
        public bool EndConnection(NodePort endPort = null) {
            ...
            if ((null == CurrentConnector.StartPort) || (null == CurrentConnector.EndPort)) {
                ...
                CurrentConnector.FlowChart.History.AddCommand(new History.CreateConnectorCommand(this,
